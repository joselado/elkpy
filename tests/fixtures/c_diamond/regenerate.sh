#!/bin/bash
# Regenerate this fixture.  Run it from inside tests/fixtures/c_diamond/.
#
...
# upstream Elk.  Seconds on one core: 0.4 s for the initial state, 4 s for
...
KEEP=(elk.in elk_init.in C.in regenerate.sh README.md
