...
! GGA functional
! ∂ρ/∂r
    call fderiv(1,nr,r,rho,gr1)
! ∇²ρ
    call fderiv(2,nr,r,rho,g2rho)
    g2rho(1:nr)=g2rho(1:nr)+2.d0*ri(1:nr)*gr1(1:nr)
! |∇ρ|
    grho(1:nr)=abs(gr1(1:nr))
! (∇ρ)⋅(∇|∇ρ|)
    call fderiv(1,nr,r,grho,gr2)
    g3rho(1:nr)=gr1(1:nr)*gr2(1:nr)
