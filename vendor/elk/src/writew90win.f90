...
write(50,'("dis_num_iter = ",I8)') dis_num_iter
write(50,*)
write(50,'("trial_step = ",G18.10)') trial_step
...
do is=1,nspecies
  do ia=1,natoms(is)
    write(50,'(" ",A,3G18.10)') trim(spsymb(is)),atposl(:,ia,is)
  end do
end do
write(50,'("end atoms_frac")')
! write the projections if required
if (projw90) then
  write(50,*)
  ...
  do is=1,nspecies
    n=nprojw90(is)
    if (n == 0) cycle
    write(50,'(" ",A,":")',advance='NO') trim(spsymb(is))
    do i=1,n
      l=lprojw90(i,is)
      write(50,'("l=",I0)',advance='NO') l
      if (i < n) write(50,'(";")',advance='NO')
    end do
    write(50,*)
  end do
